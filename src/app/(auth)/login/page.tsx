    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-orange-50 to-amber-100 p-8">
      <div className="w-full max-w-md rounded-2xl bg-white p-10 shadow-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">L&apos;Orangeraie</h1>
          <p className="mt-1 text-gray-600">Sign in with your school Google account</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          Only school accounts with access are allowed.
        </p>
      </div>
    </div>
  )
